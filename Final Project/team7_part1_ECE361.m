...
% Unsure where that 3.7254 value came from or what it is ??
%legend({"ROC: Az (area under curve)= 0.8648 | STD Deviation = 0.0451", "Opt.Pt. [PF, PD]=[0.2714, 0.80]. Thr. Opt=3.7254"}, 'Location', 'southeast');
legend({"ROC: Az (area under curve)= 0.8648 | STD Deviation = 0.0451", "Opt.Pt. [PF, PD]=[0.2714, 0.80]"}, 'Location', 'southeast');
